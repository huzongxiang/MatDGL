...
from matdgl.models import Pretrainer_dist
from matdgl.data.generator import GraphGeneratorMaskingDist
...
gnn = Pretrainer_dist(model=TransformerModel,
        atom_dim=atom_dim,
        bond_dim=bond_dim,
        num_atom=num_atom,
        state_dim=state_dim,
...
# trainning model
gnn.train(train_data, valid_data, epochs=10, lr=1e-4, workdir=ModulePath)